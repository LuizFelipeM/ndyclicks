    ...
    <div className="relative h-screen w-full overflow-x-hidden">
      <div
        className="
          ...
          bg-gradient-to-b from-neutral-silver from-1% to-transparent to-30%
        "
      />
      <div
        className="
      ...
      >
        <h1
          className="
            text-neutral-white-smoke font-Roboto font-semibold
          ...
          <div className="h-[2.6rem] md:h-16 w-fit overflow-hidden">
            <SwitchTransition mode="out-in">
              ...
              >
                <span
                  ref={topTextRef}
                  className="block text-secondary-olive-dark font-serif mr-4"
                >
                  <RichText
