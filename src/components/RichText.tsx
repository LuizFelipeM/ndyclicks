  ...
  heading1: ({ children }) => (
    <h1
      className={clsx(
        ...
        "md:after:content-[''] md:after:m-0 md:after:block md:after:w-32 md:after:h-5 md:after:bg-[url('/semi-divisa-botao-direita-MARROM.svg')] md:after:bg-contain md:after:bg-no-repeat md:after:bg-center",
